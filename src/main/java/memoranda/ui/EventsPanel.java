...
import main.java.memoranda.RepeatableEventInput;
...
public class EventsPanel extends JPanel {
	...
	int rtype;
        ...
        //Refactored method call to take parameter object. Created object and set values
        RepeatableEventInput eventInput = new RepeatableEventInput();
        eventInput.setHourVal(hh);
        eventInput.setMinuteVal(mm);
        eventInput.setPeriod(period);
        eventInput.setStartDate(sd);
        eventInput.setEndDate(ed);
        eventInput.setType(rtype);
        eventInput.setNoteText(text);
        eventInput.setWorkDays(dlg.workingDaysOnlyCB.isSelected());
        EventsManager.createRepeatableEvent(eventInput);
    }
